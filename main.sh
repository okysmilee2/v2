...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/okysmilee2/v2/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/okysmilee2/permission/main/ip"
# USERNAME
rm -f /usr/bin/user
...
echo -e "* * * * * /bin/bash -c 'sleep 0; /usr/local/kyt/udp-mini'\n* * * * * /bin/bash -c 'sleep 20; /usr/local/kyt/udp-mini'\n* * * * * /bin/bash -c 'sleep 40; /usr/local/kyt/udp-mini'" | crontab -
